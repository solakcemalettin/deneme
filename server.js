const Discord = require('discord.js'); // bu kısım hata veriyorsa modüller kurulmamıştır yani sol alttan Tools kısmına girip Terminal'e tıkla ve ( npm i ) yaz. Eğer halen olmuyorsa npm i discord.js
...
// discord.gg/cortex - Cortex Bot Eğlence-Destek sunucusu
...
// discord.gg/cortex - Cortex Bot Eğlence-Destek sunucusu
    ...
    .setDescription('❎ | Lütfen Seli Bir Kanala Giriş Yapınız!'));
     ...
     .setTitle('❎ | Şu An Zaten Şarkı Çalmıyorum!'));                                              
		...
		return undefined;// discord.gg/cortex - Cortex Bot Eğlence-Destek sunucusu
	} else if (command === 'ses') {
		if (!msg.member.voiceChannel) if (!msg.member.voiceChannel) return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
    .setDescription('❎ | Lütfen Seli Bir Kanala Giriş Yapınız!'));
